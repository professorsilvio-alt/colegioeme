...
urlpatterns = [
    ...
    path('aulas-extras/gerenciar/', views.gerenciar_aulas_extras, name='gerenciar_aulas_extras'),
    path('aulas-extras/<int:pk>/editar/', views.aula_extra_editar, name='aula_extra_editar'),
    path('aulas-extras/<int:pk>/excluir/', views.aula_extra_excluir, name='aula_extra_excluir'),
    path('aulas-extras/reatribuir/', views.aulas_extras_reatribuir, name='aulas_extras_reatribuir'),
    path('aulas-extras/excluir-varios/', views.aulas_extras_excluir_varios, name='aulas_extras_excluir_varios'),
    ...
    path('notas/rec/salvar/', views.rec_salvar, name='rec_salvar'),
    path('notas/conselho/salvar/', views.conselho_salvar, name='conselho_salvar'),
